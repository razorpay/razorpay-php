...
class VirtualAccountTest extends TestCase
{
    ...
    {       
        $data = $this->api->virtualAccount->create(array('receivers' => array('types' => array('bank_account')),'description' => 'Virtual Account created for Raftar Soft','customer_id' => $this->customerId ,'close_by' => strtotime('+15 minutes', time()), 'notes' => array('project_name' => 'Banking Software')));
